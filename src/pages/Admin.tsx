...
const FOOD_CATS_ADMIN = [
  'Шашлык','Сеты','Овощи на гриле',
  'Садж','Ассорти овощей','Холодные закуски',
  'Салаты','Хачапури','Жульен','Супы',
  'Плов','Хинкали','Горячее','Рыба','Котлеты',
  'Гарниры','Паста','Кутабы','Соусы',
  'Десерты','Чай','Завтрак','Пицца','Хлеб','Фрукты',
];
