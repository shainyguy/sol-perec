...
const PACKAGES = [
  { id: 'base', name: 'Базовый', price: 4000, color: 'border-blue-500/40 bg-blue-500/5', activeColor: 'border-blue-500 bg-blue-500/15', badge: 'bg-blue-500',
    includes: ['🧀 Холодные закуски (ассорти салатов, сырная тарелка)','🥩 Шашлык на мангале (курица / свинина / телятина)','🥘 Садж на выбор','🍲 Горячие блюда (на выбор)','🥗 Гарниры и соусы','🥤 Напитки (морс, лимонад, вода)','🍞 Хлебная корзинка','🎵 Живая музыка'] },
  { id: 'extended', name: 'Расширенный', price: 5000, color: 'border-sp-orange/40 bg-sp-orange/5', activeColor: 'border-sp-orange bg-sp-orange/15', badge: 'bg-sp-orange',
    includes: ['🍖 Мясное и рыбное ассорти','🥟 Домашние закуски (хачапури, кутабы, долма)','🍢 Шашлычный микс (баранина + телятина + курица)','🥘 Садж ассорти','🍲 Горячее на выбор + гарниры','🥗 Салатная тарелка (4 вида)','🧀 Сырная тарелка','🍰 Десерты (медовик, пахлава)','🎵 Живая музыка + DJ'] },
  { id: 'vip', name: 'VIP', price: 6000, color: 'border-yellow-500/40 bg-yellow-500/5', activeColor: 'border-yellow-500 bg-yellow-500/15', badge: 'bg-yellow-500',
    includes: ['🔥 Фирменный сет «Соль и Перец»','🥩 Шашлык из баранины и телятины','🥘 Садж ассорти (3 вида мяса)','🍚 Плов фирменный / шах-плов','🐟 Рыба на мангале (форель / сибас)','🥟 Хачапури, кутабы, хинкали','🍰 Десертный сет','🥤 Свежевыжатые соки и напитки','🎵 Живая музыка + DJ + ведущий'] },
];
