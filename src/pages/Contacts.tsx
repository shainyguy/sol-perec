...
export default function Contacts() {
  return (
    <div className="min-h-screen bg-sp-darkest pt-20">
      ...
      <meta name="description" content="Контакты кафе Соль и Перец в Сходне. Адрес: ул. Некрасова 15, Химки. Телефон: +7 (905) 547-16-40. Часы работы, схема проезда." />
          ...
          >
            <div className="contact-card">
              ...
              <div>
                ...
                <a href="tel:+79055471640" className="text-sp-cream text-xl font-semibold hover:text-sp-orange transition-colors">
                  +7 (905) 547-16-40
                </a>
                <div className="mt-3">
